...
الإصدار: `2026.08.26.4-v328`

واجهة v328 مستوحاة من تنظيم تطبيقات التلفزيون المباشرة: شاشة قوائم تشغيل، لوحة رئيسية مختصرة، بث مباشر بثلاثة أعمدة، وإعدادات شبكية؛ جميعها بهوية BLOFY البنفسجية ودعم كامل للريموت.
