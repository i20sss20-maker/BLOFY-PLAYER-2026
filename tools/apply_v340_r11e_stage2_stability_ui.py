...
# Chain the package-cache hardening before stage3 stamps the signed release.
runpy.run_path(str(ROOT / "tools/apply_v340_r11e_stage4_package_cache.py"), run_name="__main__")
