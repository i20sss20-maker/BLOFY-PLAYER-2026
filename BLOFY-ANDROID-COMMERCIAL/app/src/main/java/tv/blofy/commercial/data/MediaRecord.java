...
public final class MediaRecord {
    public final String type, id, name, image, backdrop, categoryId, rating, year, extension, directSource;
    ...
    public MediaRecord(String type, String id, String name, String image, String backdrop,
        ...
        this(type, id, name, image, backdrop, categoryId, rating, year, extension, "");
    }
    ...
    public MediaRecord(String type, String id, String name, String image, String backdrop,
        ...
        this.year = safe(year); this.extension = safe(extension); this.directSource = safe(directSource);
    }
    ...
    public static MediaRecord from(JSONObject row, String type) {
        return new MediaRecord(row.optString("type", type), row.optString("id"), row.optString("name"),
                ...
                row.optString("directSource", row.optString("direct_source")));
    }
